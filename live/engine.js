...
function bootShow(msg, sub){
  ...
  if(!b){
    ...
    b.innerHTML='<div class="boot-mark" aria-hidden="true">'
      +'<svg class="boot-svg" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><defs><clipPath id="rwind"><circle cx="17" cy="32" r="15"/></clipPath><clipPath id="rtemp"><circle cx="32" cy="17" r="15"/></clipPath><clipPath id="rrain"><circle cx="47" cy="32" r="15"/></clipPath><clipPath id="rcloud"><circle cx="32" cy="47" r="15"/></clipPath></defs><circle class="ql ql-wind" cx="17" cy="32" r="15" fill="#A8E63E"/><circle class="ql ql-temp" cx="32" cy="17" r="15" fill="#7EE8A5"/><circle class="ql ql-rain" cx="47" cy="32" r="15" fill="#5FA4FF"/><circle class="ql ql-cloud" cx="32" cy="47" r="15" fill="#C8A6FF"/><g class="qo qo-wind-temp" clip-path="url(#rtemp)"><circle cx="17" cy="32" r="15" fill="#D3FDBB"/></g><g class="qo qo-temp-rain" clip-path="url(#rrain)"><circle cx="32" cy="17" r="15" fill="#AEF7FF"/></g><g class="qo qo-rain-cloud" clip-path="url(#rcloud)"><circle cx="47" cy="32" r="15" fill="#DCDFFF"/></g><g class="qo qo-cloud-wind" clip-path="url(#rwind)"><circle cx="32" cy="47" r="15" fill="#ECF6FF"/></g></svg></div>'
